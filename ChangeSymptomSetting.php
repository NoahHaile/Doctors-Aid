...
<div class="error-msg msg">
 ...
 It is not successful!
        ...
        <div class="row">
        <form name="addMed" method="post" action="core/css.php">
                ...
                <input type="submit" name="sub1" value="Add Symptom" class="btn btnmsg1">
            </form>

            <form action="core/css.php" method="post" class="form2" name="form2">
                <h3>Edit <span>Disease</span></h3>
                <select id="form2select" name="form2select">
                <option value="" disabled selected hidden>Select symptom Type</option>
                <?php
                ...
                if(!sqlsrv_execute($stmt))
                  ...
                  $symptom[$num++] = $row['Sname'];
                  $symptom[$num++] = $row['Sdescription'];
                  }
                ?>
                  </select>
                <div class="lbl"><label class="lbl" for="addName">Name</label></div>
                <input type="text" id="addName" placeholder="Name" class="box" name="name">
                <div class="lbl"><label class="lbl" for="addDesc">Description</label></div>
                <textarea id="addDesc" class="txtbox" name="txtbox"></textarea required>
                <input type="submit" name="sub2" value="Update Symptom" class="btn btnmsg1">
            </form>


            <form  action="core/css.php" method="post" class="form3">
...
<script src="js/script.js"></script>
   ...
   <script src="js/delete.js"></script> 
    ...
    if(dmode=='dark'){
     ...
     <script>
    var js_arr = '<?php echo JSON_encode( $symptom);?>';
